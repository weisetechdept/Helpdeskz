DROP TABLE IF EXISTS `tpmhdz_api`;
CREATE TABLE `tpmhdz_api` (
  `id` int NOT NULL,
...
DROP TABLE IF EXISTS `tpmhdz_articles`;
CREATE TABLE `tpmhdz_articles` (
  `id` int NOT NULL,
...
DROP TABLE IF EXISTS `tpmhdz_attachments`;
CREATE TABLE `tpmhdz_attachments` (
  `id` int NOT NULL,
...
DROP TABLE IF EXISTS `tpmhdz_canned_response`;
CREATE TABLE `tpmhdz_canned_response` (
  `id` int NOT NULL,
...
DROP TABLE IF EXISTS `tpmhdz_config`;
CREATE TABLE `tpmhdz_config` (
  `id` int NOT NULL,
...
DROP TABLE IF EXISTS `tpmhdz_custom_fields`;
CREATE TABLE `tpmhdz_custom_fields` (
  `id` int NOT NULL,
...
DROP TABLE IF EXISTS `tpmhdz_departments`;
CREATE TABLE `tpmhdz_departments` (
  `id` int NOT NULL,
...
DROP TABLE IF EXISTS `tpmhdz_emails`;
CREATE TABLE `tpmhdz_emails` (
  `id` int NOT NULL,
...
DROP TABLE IF EXISTS `tpmhdz_emails_tpl`;
CREATE TABLE `tpmhdz_emails_tpl` (
...
DROP TABLE IF EXISTS `tpmhdz_kb_category`;
CREATE TABLE `tpmhdz_kb_category` (
  `id` int NOT NULL,
  `name` varchar(200) NOT NULL,
...
DROP TABLE IF EXISTS `tpmhdz_login_attempt`;
CREATE TABLE `tpmhdz_login_attempt` (
  `ip` varchar(200) NOT NULL,
  `attempts` int NOT NULL DEFAULT '0',
  `date` int NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

DROP TABLE IF EXISTS `tpmhdz_login_log`;
CREATE TABLE `tpmhdz_login_log` (
  `id` int NOT NULL,
  `date` int NOT NULL,
  `staff_id` int NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `tpmhdz_priority`;
CREATE TABLE `tpmhdz_priority` (
  `id` int NOT NULL,
  `name` varchar(255) NOT NULL,
  `color` varchar(10) NOT NULL DEFAULT '#000000'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

DROP TABLE IF EXISTS `tpmhdz_staff`;
CREATE TABLE `tpmhdz_staff` (
  `id` int NOT NULL,
...
DROP TABLE IF EXISTS `tpmhdz_tickets`;
CREATE TABLE `tpmhdz_tickets` (
  `id` int NOT NULL,
  `department_id` int NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `tpmhdz_tickets_messages`;
CREATE TABLE `tpmhdz_tickets_messages` (
  `id` int NOT NULL,
  `ticket_id` int NOT NULL DEFAULT '0',
  `date` int NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `tpmhdz_ticket_notes`;
CREATE TABLE `tpmhdz_ticket_notes` (
...
DROP TABLE IF EXISTS `tpmhdz_users`;
CREATE TABLE `tpmhdz_users` (
  `id` int NOT NULL,
...
ALTER TABLE `tpmhdz_api`
  ADD PRIMARY KEY (`id`),
  ADD KEY `token` (`token`);

ALTER TABLE `tpmhdz_articles`
  ADD PRIMARY KEY (`id`),
  ADD KEY `category` (`category`);

ALTER TABLE `tpmhdz_attachments`
  ADD PRIMARY KEY (`id`),
  ADD KEY `article_id` (`article_id`),
  ADD KEY `ticket_id` (`ticket_id`),
  ADD KEY `msg_id` (`msg_id`);

ALTER TABLE `tpmhdz_canned_response`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `tpmhdz_config`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `tpmhdz_custom_fields`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `tpmhdz_departments`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `tpmhdz_emails`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `tpmhdz_emails_tpl`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `tpmhdz_kb_category`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `tpmhdz_login_attempt`
  ADD UNIQUE KEY `ip` (`ip`);

ALTER TABLE `tpmhdz_login_log`
  ADD PRIMARY KEY (`id`),
  ADD KEY `staff_id` (`staff_id`);

ALTER TABLE `tpmhdz_priority`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `tpmhdz_staff`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `tpmhdz_tickets`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `tpmhdz_tickets_messages`
  ADD PRIMARY KEY (`id`),
  ADD KEY `ticket_id` (`ticket_id`);

ALTER TABLE `tpmhdz_users`
  ADD PRIMARY KEY (`id`),
  ADD KEY `email` (`email`);
...
INSERT INTO `tpmhdz_config` (`id`, `logo`, `site_name`, `windows_title`, `page_size`, `date_format`, `timezone`, `recaptcha`, `recaptcha_sitekey`, `recaptcha_privatekey`, `login_attempt`, `login_attempt_minutes`, `reply_order`, `tickets_page`, `tickets_replies`, `overdue_time`, `ticket_autoclose`, `ticket_attachment`, `ticket_attachment_number`, `ticket_file_size`, `ticket_file_type`, `kb_articles`, `kb_maxchar`, `kb_popular`, `kb_latest`) VALUES
...
INSERT INTO `tpmhdz_departments` (`id`, `dep_order`, `name`, `private`) VALUES
(1, 1, 'General', 0),
(2, 2, 'Advertising', 0),
(3, 3, 'Sales', 0);
INSERT INTO `tpmhdz_emails_tpl` (`id`, `position`, `name`, `subject`, `message`, `last_update`, `status`) VALUES
...
INSERT INTO `tpmhdz_priority` (`id`, `name`, `color`) VALUES
(1, 'Low', '#8A8A8A'),
(2, 'Medium', '#000000'),
(3, 'High', '#F07D18'),
(4, 'Urgent', '#E826C6'),
